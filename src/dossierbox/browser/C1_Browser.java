...
final class C1_Browser extends DossierBrowser {
    ...
    public C1_Browser(Subject Administrador, Cipher decrypter) {
    ...
    public boolean hasNext() {
        ...
        if (scopeNodeList == null) {
            scopeNodeList = document.getElementsByTagName("scopeC");
        }
